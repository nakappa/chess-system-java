...
public class UI {
	...
	public static ChessPosition readChessPosition(Scanner sc) {
		try {
			...
			throw new InputMismatchException("Error reading ChessPosition. Valid values are from ai to h8.");
		}
	}
	...
	private static void printCapturedPieces(List<ChessPiece> captured) {
		...
		System.out.println(Arrays.deepToString(white.toArray())); // geitinho padrão para imprimir um array de valores não java
		System.out.print(ANSI_RESET);
		System.out.print("Black: ");
		System.out.print(ANSI_YELLOW);
		System.out.println(Arrays.deepToString(black.toArray())); // geitinho padrão para imprimir um array de valores não java
		System.out.print(ANSI_RESET);
	}
}
